...
As we did in chapters \@ref(curate-master-ukb-events-table) and \@ref(prep-pcp-data), we exclude any subjects who have mismatch between self-reported sex and genetically determined sex. However, we also remove any measurements whose dates are coded as special dates. If biomarker measurements or their dates are missing, we exclude those measurements from the trajectory table as well.
