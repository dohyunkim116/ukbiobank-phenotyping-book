...
#Select f.eid, whether or not dm is known, whether or not cvd occurred, and the lower and upper bounds on time-to-event 
cvd_interval <- tab %>% select('f.eid', 'known','event', 'lower', 'upper')
```
Save the resulting intervals
```{r}
saveRDS(cvd_tte_interval, "generated_data/cvd_interval.RDS")
```
